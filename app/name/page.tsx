...
const data = await db.select().from(namesTable)
  return (
    <section
        className='bg-gray-100 dark:bg-[#0d0d1f] dark:text-white px-6 min-h-screen md:pt-8 pt-16'>
          <SearchInput />
          <div className='mb-2 py-2 max-w-7xl'>
            <h1 className='text-2xl md:text-3xl dark:text-white text-[#0f3d2e] font-bold mb-2'>
